...
public class testDCPDownload {
    public static void main(String[] args) {
        String sURL = "https://restgk.guanzongroup.com.ph/integsys/dcp/dcp_download.php";
        
        Map<String, String> headers = APIParam.getHeader1();
        
        JSONObject param = new JSONObject();
        param.put("sEmployID", "M04108000065");
        param.put("dTransact", "2023-02-01");

...
public class testRandomStockInventory {
    public static void main(String[] args) {
        String sURL = "https://restgk.guanzongroup.com.ph/integsys/bullseye/random_stock_inventory_request.php";
        
        Map<String, String> headers = APIParam.getHeader1();
        
        JSONObject param = new JSONObject();
        param.put("branchcd", "M001");

...
public class testDeactivatePersonnel {
    public static void main(String[] args) {
        String sURL = "https://restgk.guanzongroup.com.ph/gsecure/personnel/deactivate_personnel.php";
        
        Map<String, String> headers = APIParam.getHeader1();
        
        JSONObject param = new JSONObject();
        param.put("sUserIDxx", "MX0124000002");

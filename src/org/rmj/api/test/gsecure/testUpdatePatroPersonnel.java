...
public class testUpdatePatroPersonnel {
    public static void main(String[] args) {
        String sURL = "https://restgk.guanzongroup.com.ph/gsecure/patrol/update_patrol_personnel.php";
        
        Map<String, String> headers = APIParam.getHeader1();
        
        JSONObject param = new JSONObject();
        param.put("sPersonnl", "MX0123000004");

 ...
 * @author user
 */
public class testDocusignUpdateContact {
    public static void main(String[] args) {
        String sURL = "http://localhost/integsys/param/update_mc_contract.php";
        
        Map<String, String> headers = APIParam.getHeader1();
        
        JSONObject param = new JSONObject();
        param.put("sReferNox", "FH9Q92600003");
        param.put("sClientID", "M00123000001");
